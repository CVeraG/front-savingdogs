...
export default function DogFound() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('http://localhost:8482/apiPerroencontrado/registroEncontrado', {
        method: 'POST',
        headers: {
        ...
        <div className="mt-5 w-auto flex flex-row justify-between">
          ...
          <div className="h-auto flex flex-col w-[35%] border-2 py-5 px-3">
            <span className="font-sifonn mb-5">
              Dirección de Localización del Perro
            </span>
            <span className="mb-5">
              <TextField
                size="small"
